...
def topology(args):
    ...
    sw1 = net.addSwitch('sw1', position='20,20,0', failMode='standalone')
    sw2 = net.addSwitch('sw2', position='80,20,0', failMode='standalone')
    sw3 = net.addSwitch('sw3', position='80,80,0', failMode='standalone')
    sw4 = net.addSwitch('sw4', position='20,80,0', failMode='standalone')
    sw5 = net.addSwitch('sw5', position='40,40,0', failMode='standalone')
